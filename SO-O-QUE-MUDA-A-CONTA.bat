...
chcp 65001 > nul
set PYTHONUTF8=1
title SO O QUE MUDA A CONTA - filtra o PRECISA-REFAZER
cd /d "%~dp0"
if not exist "config.txt" cd ..
if not exist "config.txt" goto :SEMCASA
echo.
echo  ==============================================================
echo   SO O QUE MUDA A CONTA
echo  ==============================================================
echo.
...
echo.
echo   Guarda o PRECISA-REFAZER original antes de filtrar.
echo.
echo  --------------------------------------------------------------
python "%~dp0programas\so_o_que_muda_a_conta.py" 
