...
:root{
""" + _vars(TOK_ESCURO) + """
 --t6-hire-top-fg:#f1fff7;--t6-hire-top-bg:linear-gradient(135deg,#063b23,#0d8148);--t6-hire-top-bd:#70ffb5;--t6-hire-top-sh:0 0 13px #48e58ca8,inset 0 0 10px #8dffc333;
 --t6-hire-any-fg:#d9ffea;--t6-hire-any-bg:rgba(24,151,85,.34);--t6-hire-any-bd:#38d989;
 --t6-hire-pay-fg:#cffff0;--t6-hire-pay-bg:rgba(70,164,93,.27);--t6-hire-pay-bd:#64c982;
 --t6-hire-worth-fg:#ffe49a;--t6-hire-worth-bg:rgba(221,161,45,.22);--t6-hire-worth-bd:#dda12d;
 --t6-hire-cheap-fg:#ffc18d;--t6-hire-cheap-bg:rgba(216,107,44,.24);--t6-hire-cheap-bd:#dc7134;
 --t6-hire-free-fg:#ffb1a7;--t6-hire-free-bg:rgba(200,69,54,.28);--t6-hire-free-bd:#df6455;
}
...
""" + _vars(TOK_CLARO) + """
 --t6-hire-top-fg:#ffffff;--t6-hire-top-bg:linear-gradient(135deg,#07532f,#0b8b4e);--t6-hire-top-bd:#064326;--t6-hire-top-sh:0 0 10px #10a86166,inset 0 0 8px #d8ffea38;
 --t6-hire-any-fg:#075c3a;--t6-hire-any-bg:#d7f4e3;--t6-hire-any-bd:#289462;
 --t6-hire-pay-fg:#18552e;--t6-hire-pay-bg:#e0f2df;--t6-hire-pay-bd:#62a96f;
 --t6-hire-worth-fg:#654600;--t6-hire-worth-bg:#fff0b9;--t6-hire-worth-bd:#c78d16;
 --t6-hire-cheap-fg:#703500;--t6-hire-cheap-bg:#ffe2bd;--t6-hire-cheap-bd:#d47618;
 --t6-hire-free-fg:#ffffff;--t6-hire-free-bg:#c84536;--t6-hire-free-bd:#8f271f;
}
...
@media(max-width:820px){
 ...
 .t6tela [data-t6boxfiltros]{
  display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;
  gap:10px!important;align-items:center!important;width:100%!important}
 .t6tela [data-t6boxfiltros]>h2,
 .t6tela [data-t6boxfiltros]>[data-t6boxfiltro]{grid-column:1/-1!important}
 .t6tela [data-t6boxfiltros]>input{width:100%!important;max-width:none!important;min-width:0!important}
 .t6tela [data-t6boxfiltros]>[data-t6boxalternar]{
  grid-column:1/-1!important;justify-self:end!important;margin-left:0!important}
 ...
 .t6tela [data-t6boxlinha] [data-t6boxfoto]{
  grid-column:1!important;grid-row:1 / span 3!important;width:64px!important;
 ...
 .t6tela [data-t6boxlinha] [data-t6score]>b{
 ...
 .t6tela [data-t6boxlinha] [data-t6score] [data-t6rec]{
  grid-column:2 / 4!important;grid-row:2!important;align-self:end!important;
  justify-self:start!important;margin-top:8px!important;text-align:left!important}
 .t6tela [data-t6boxlinha] [data-t6score] [data-t6veredito]{
  grid-column:2 / 4!important;grid-row:3!important;justify-self:start!important;align-self:start!important}
...
(function(){
  ...
  window.t6CarregaCadastroBoxes = function(status){
    status=status||(window._t6aba==='boxatual'?'atual':'anterior');
    ...
    .then(function(boxes){
      ...
      function carregaRestante(){
        ...
        .then(function(lote){
          ...
          else if(window._t6aba==='boxatual'||window._t6aba==='boxant')window.t6Painel(window._t6aba);
        }).catch(function(){});
        },0,24);
      }
      window.t6CarregaBoxesPrimeiro(function(){
        ...
        if(window._t6aba==='boxatual'||window._t6aba==='boxant')window.t6Painel(window._t6aba);
        carregaRestante();
      });
  ...
  window.t6CarregaBoxesPrimeiro = function(aoTerminar){
    ...
    var ativas={}, ids=[], historicas=(window._t6aba==='boxant');
    try{
    ...
    Promise.all([urlTop,url].map(function(u){
      return fetch(u,{headers:cab}).then(function(r){
       ...
       else try{if(window._t6aba==='boxatual'||window._t6aba==='boxant')window.t6Painel(window._t6aba);}catch(e){}
  ...
  window.t6Cliques = function(raiz){
    ...
    if (troca) troca.onclick = function(){
      var proxima = window._t6aba === 'boxant' ? 'boxatual' : 'boxant';
      window._t6aba = proxima;
      window._t6boxesCargaRapida = 0;
    ...
    raiz.querySelectorAll('[data-t6abrirbox]').forEach(function(el){
      el.onclick=function(ev){ ev.stopPropagation(); window.t6AbreBox(el.dataset.t6abrirbox, el.dataset.t6origem || window._t6aba); };
    });
    ...
    if (filtro){
      ...
      filtro.oninput = function(){
        ...
        window._t6FiltroBoxesTimer = setTimeout(function(){
          window.t6Painel(window._t6aba || 'boxant');
          setTimeout(function(){
    ...
    raiz.querySelectorAll('[data-t6boxdata]').forEach(function(el){
      ...
      el.onchange = function(){
        window[el.getAttribute('data-t6boxdata')] = el.value || '';
        window.t6Painel(window._t6aba || 'boxant');
      };
    });
  ...
  if(window._t6aba==='boxatual'||window._t6aba==='boxant') setTimeout(window.t6CarregaBoxesPrimeiro,0);
  ...
  window.t6TelaBoxes = function(anteriores){
    ...
    var filtroHtml = anteriores
      ? '<input data-t6boxfiltro placeholder="pesquisar por nome" style="width:180px;max-width:30%;padding:8px 10px;border-radius:9px;border:1px solid var(--d18);background:var(--d10);color:var(--d8);font:inherit;font-size:12px">'
        + '<input type="date" data-t6boxdata="_t6BoxDataDe" title="data inicial" style="width:135px;padding:8px 9px;border-radius:9px;border:1px solid var(--d18);background:var(--d10);color:var(--d8);font:inherit;font-size:12px">'
        + '<input type="date" data-t6boxdata="_t6BoxDataAte" title="data final" style="width:135px;padding:8px 9px;border-radius:9px;border:1px solid var(--d18);background:var(--d10);color:var(--d8);font:inherit;font-size:12px">'
      : '';
    var h = '<div style="padding:22px;display:flex;flex-direction:column;gap:16px">'
      + '<div data-t6boxfiltros="1" style="display:flex;align-items:center;justify-content:flex-end;gap:12px;flex-wrap:wrap"><h2 style="margin:0;font-size:19px;font-weight:700;flex:1 1 auto">' + titulo + '</h2>'
      + filtroHtml + '<button data-t6boxalternar="1" style="margin-left:auto;border:1px solid var(--d18);background:var(--d32);color:var(--d30);padding:7px 11px;border-radius:9px;cursor:pointer">' + acao + '</button></div>'
  ...
  window.t6AbreBox = function(nome, origem){
    ...
    window._t6aba = window._t6BoxRetorno || 'boxatual';
  ...
  function veredicto(p, congelado, codigoCongelado){
    ...
    if (codigo==='pagar' || fixo==='PAGAR') return [nome('pagar','PAGAR'), 'var(--t6-hire-pay-fg)', 'var(--t6-hire-pay-bg)', 'var(--t6-hire-pay-bd)'];
    ...
    if (p >= C[1]) return [nome('pagar','PAGAR'), 'var(--t6-hire-pay-fg)', 'var(--t6-hire-pay-bg)', 'var(--t6-hire-pay-bd)'];
  ...
  window.t6TelaInicio = function(){
    ...
    h = h.replace(
      ...
      'PAGAR QUALQUER PREÇO: 100%. PAGAR CARO: de 99% até 99,99%. PAGAR: de 98% até 98,99%. PAGAR POUCO: de 97% até 97,99%. PAGAR MUITO POUCO: de 96% até 96,99%. NÃO PAGAR: abaixo de 96%.'
    );
    return h;
  };
  ...
  function t6RemoveControlesGlobais(){
    if (!document.body) return;
    /* A busca flutuante e o atalho do motor eram ferramentas internas e
       apareciam por cima de todas as paginas. Saem da origem compartilhada,
       em vez de serem apenas escondidos em uma tela especifica. */
    ['gbBt','gbWrap'].forEach(function(id){
      var el=document.getElementById(id);
      if(el && el.parentNode) el.parentNode.removeChild(el);
    });
    [].slice.call(document.body.children).forEach(function(el){
      if ((el.textContent || '').trim() === '⚙ motor' && el.parentNode)
        el.parentNode.removeChild(el);
    });
  }
  if (!window._T6_CROMO_OBS && typeof MutationObserver !== 'undefined'){
    window._T6_CROMO_OBS = new MutationObserver(function(){ t6RemoveControlesGlobais(); });
